...
d3.json("details.json").then((data) => {
  ...
  const ip_date = function (datum, i, n) {
    console.log(datum[i].posts[i].pub_date);
    return datum[i].posts[i].pub_date;
  };
  ...
  //
  // console.log(data[0].posts[0].pub_date);
  texts
    .enter()
    .append("text")
    .text((d) => d.year)
